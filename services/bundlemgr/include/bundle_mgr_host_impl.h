...
public:
    ...
    /**
     * @brief Query the optimal extension info by the given Want, system app first then
     *        ascending by bundleName.
     * @param want Indicates the information of extension info.
    ...
    /**
     * @brief Obtains the optimal ExtensionAbilityInfo of a sandbox app, system app first
     *        then ascending by bundleName.
     * @param want Indicates the information of the ability.
    ...
    virtual ErrCode SetAdditionalInfoByIndex(const std::string &bundleName,
    ...
    virtual ErrCode SetApplicationDisableForbidden(const std::string &bundleName, int32_t userId, int32_t appIndex,
        bool forbidden) override;
    /**
     * @brief Obtains the DualModeBundleInfo based on a given bundle name.
     * @param bundleName Indicates the application bundle name to be queried.
     * @param userId Indicates the user ID.
     * @param dualModeBundleInfo Indicates the obtained DualModeBundleInfo object.
     * @return Returns true if the DualModeBundleInfo is successfully obtained; returns false otherwise.
     */
...
private:
    ...
    ErrCode CheckBatchSetPermission();
