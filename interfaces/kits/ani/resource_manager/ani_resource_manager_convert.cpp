...
ani_object AniResourceManagerConvert::ConvertBundleResourceInfo(ani_env* env, const BundleResourceInfo& bundleResInfo)
{
...
ani_object AniResourceManagerConvert::ConvertLauncherAbilityResourceInfo(ani_env* env,
