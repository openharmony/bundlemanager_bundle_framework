...
constexpr const char* GET_BUNDLE_EXTENSION_POLICY_INFO = "GetBundleExtensionPolicyInfo";
...
constexpr const char* GET_APP_PROVISION_INFO_IN_DEVICE = "GetAppProvisionInfoInDevice";
constexpr const char* GET_ALL_APP_PROVISION_INFO_IN_DEVICE = "getAllAppProvisionInfoInDevice";
...
constexpr uint32_t MAX_POLICY_ARRAY_SIZE = 1000;
