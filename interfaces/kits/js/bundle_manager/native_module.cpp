...
static napi_value BundleManagerExport(napi_env env, napi_value exports)
{
    ...
    napi_property_descriptor desc[] = {
        ...
        DECLARE_NAPI_FUNCTION("setAdditionalInfoByIndex", SetAdditionalInfoByIndex),
        ...
        DECLARE_NAPI_FUNCTION("getAppProvisionInfoInDevice", GetAppProvisionInfoInDevice),
        DECLARE_NAPI_FUNCTION("getAllAppProvisionInfoInDevice", GetAllAppProvisionInfoInDevice),
