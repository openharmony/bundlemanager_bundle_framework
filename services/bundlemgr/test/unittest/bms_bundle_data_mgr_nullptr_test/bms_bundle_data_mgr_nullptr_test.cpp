...
/**
 * @tc.number: BundleCacheMgr_0007
 * @tc.name: test GetBundleFileCounts
 * @tc.desc: 1.Test GetBundleFileCount the BundleCacheMgr
*/
HWTEST_F(BmsBundleDataMgrNullptrTest, BundleCacheMgr_0007, Function | MediumTest | Level1)
{
    BundleCacheMgr bundleCacheMgr;
    std::vector<int32_t> uids;
    uint64_t fileCount = 0;
    ErrCode ret = bundleCacheMgr.GetBundleFileCount(uids, fileCount);
