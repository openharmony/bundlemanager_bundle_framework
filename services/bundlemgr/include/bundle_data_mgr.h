...
public:
    ...
    bool GetBundleStats(const std::string &bundleName,
        ...
        int32_t activeUserId = Constants::INVALID_USERID) const;
    ...
    ErrCode GetAllAppProvisionInfoInDevice(const int32_t userId, std::vector<AppProvisionInfo> &appProvisionInfos);
    ...
    ErrCode SetAdditionalInfoByIndex(const std::string& bundleName,
