...
enum {
    ...
    // get distributed bundleName  errcode
    ERR_GET_DISTRIBUTED_BUNDLE_NAME_GET_UDID_FAIL = APPEXECFWK_BUNDLEMGR_ERR_OFFSET + 0x0701, // 8521473,
    ERR_GET_DISTRIBUTED_BUNDLE_NAME_UDID_IS_EMPTY,
    ERR_GET_DISTRIBUTED_BUNDLE_NAME_KVSTORE_IS_NULLPTR,
    ERR_GET_DISTRIBUTED_BUNDLE_NAME_NO_MATCHES,
    ERR_GET_DISTRIBUTED_BUNDLE_NAME_QUERY_DB_FAIL,
};
