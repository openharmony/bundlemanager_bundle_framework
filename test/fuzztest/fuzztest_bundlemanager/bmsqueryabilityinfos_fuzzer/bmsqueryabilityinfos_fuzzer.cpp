...
#include "bmsqueryabilityinfos_fuzzer.h"
...
namespace OHOS {
    bool DoSomethingInterestingWithMyAPI(const uint8_t* data, size_t size)
    {
        ...
        bundleMgrProxy.QueryAbilityInfos(want, flags, userId, abilityInfos);
        bundleMgrProxy.QueryAbilityInfosV9(want, flags, userId, abilityInfos);
        return true;
    }
}
