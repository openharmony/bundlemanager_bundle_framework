...
#ifndef BMS_SERVICES_INCLUDE_ECOLOGICAL_RULE_MANAGER_SERVICE_LITE_H
#define BMS_SERVICES_INCLUDE_ECOLOGICAL_RULE_MANAGER_SERVICE_LITE_H
...
#endif // BMS_SERVICES_INCLUDE_ECOLOGICAL_RULE_MANAGER_SERVICE_LITE_H
