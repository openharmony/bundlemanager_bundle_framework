...
bool FormInfo::ReadCustomizeData(Parcel &parcel)
{
    ...
    VECTOR_SECURITY_VERIFY(parcel, customizeDataSize, &customizeDatas);
...
bool FormInfo::ReadFromParcel(Parcel &parcel)
{
    ...
    VECTOR_SECURITY_VERIFY(parcel, supportDimensionSize, &supportDimensions);
    ...
    VECTOR_SECURITY_VERIFY(parcel, landscapeLayoutsSize, &landscapeLayouts);
    ...
    VECTOR_SECURITY_VERIFY(parcel, portraitLayoutsSize, &portraitLayouts);
