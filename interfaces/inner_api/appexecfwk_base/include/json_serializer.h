...
void to_json(nlohmann::json &jsonObject, const DualModeBundleInfo &dualModeBundleInfo);
void from_json(const nlohmann::json &jsonObject, DualModeBundleInfo &dualModeBundleInfo);
}  // namespace AppExecFwk
}  // namespace OHOS
