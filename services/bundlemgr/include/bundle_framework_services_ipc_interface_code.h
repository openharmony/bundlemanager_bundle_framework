...
enum class InstalldInterfaceCode : uint32_t {
    ...
    COPY_SERVICE_HSP = 99,
    COPY_PGO_FILE = 100,
    COPY_HAP_TO_INSTALL_PATH = 101,
    COPY_EXTEND_RESOURCE_FILE = 102,
    COPY_EXTEND_PROFILE_FILE = 103,
    COPY_SHARED_HSP = 104,
    EXTRACT_HAP_MODULE_FILES = 105,
    EXTRACT_HNP_FILES_BY_SCENE = 106,
    MOVE_PLUGIN_HSP_TO_CODE_DIR = 118,
