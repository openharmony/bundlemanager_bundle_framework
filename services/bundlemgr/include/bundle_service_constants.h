...
constexpr const char* ABCS_TEMP_DIR_PATH = "abcs/temp/";
// uid and gid
...
constexpr int32_t PRINT_SERVICE_GID = 3823;
// first isntall time
...
constexpr const char* PERMISSION_DEFAULT_WEB_BROWSER = "ohos.permission.DEFAULT_WEB_BROWSER";
...
// Dual-mode params: persist.sceneboard.ispcmode (bool: true=2in1/false=tablet, current mode),
// const.sceneboard.mainmode (int: 0=tablet/1=2in1, main mode). Missing/unreadable/illegal -> non-dual-mode device.
