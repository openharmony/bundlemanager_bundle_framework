...
enum {
    ...
    // query errcode
    ERR_QUERY_INTERNAL_ERROR = APPEXECFWK_BUNDLEMGR_ERR_OFFSET + 0x0601, // 8521217
    ERR_QUERY_INVALID_USER_ID,
    ERR_QUERY_ABILITY_NOT_EXIST,
    ERR_QUERY_ABILITY_DISABLED,
    ERR_QUERY_APPLICATION_DISABLED,
    ERR_QUERY_PARAM_ERROR,
    ERR_QUERY_PERMISSION_DENIED,
