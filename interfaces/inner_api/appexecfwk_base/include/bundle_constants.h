...
// pre bundle profile
constexpr const char* DEFAULT_PRE_BUNDLE_PROFILE = "/system/etc/bundle";
constexpr const char* PREINSTALL_CONFIG = "/preinstall_config.json";
constexpr const char* PREINSTALL_UNINSTALL_CONFIG = "/pre_uninstall_config.json";
constexpr const char* PREINSTALL_ABILITY_CONFIG = "/preinstall_ability_config.json";
