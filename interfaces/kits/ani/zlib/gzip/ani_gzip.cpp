...
constexpr const char FORMAT_INT_D = 'd';
constexpr const char FORMAT_INT_I = 'i';
constexpr const char FORMAT_CHAR = 's';
constexpr const char FORMAT_ESCAPE = '%';
