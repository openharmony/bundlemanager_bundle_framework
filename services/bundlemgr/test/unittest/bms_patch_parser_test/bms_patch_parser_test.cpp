...
HWTEST_F(BmsPatchParserTest, TestParse_0001, Function | SmallTest | Level0)
{
    ...
    EXPECT_EQ(appQuickFix.bundleName, "com.ohos.systemui");
    ...
    EXPECT_EQ(appQuickFix.deployingAppqfInfo.cpuAbi, "armeabi-v7a");
    ...
    EXPECT_EQ(appQuickFix.deployingAppqfInfo.hqfInfos[0].moduleName, "default_navigationBar");
}
 ...
 * @tc.require: AR000HBO6
 * @tc.desc: 1. system running normally
 *           2. test parse patch failed when versionName does not exist in the patch.json
 */
 ...
 * @tc.require: AR000HBO6
 * @tc.desc: 1. system running normally
 *           2. test parse patch failed when originalModuleHash does not exist in the patch.json
 */
