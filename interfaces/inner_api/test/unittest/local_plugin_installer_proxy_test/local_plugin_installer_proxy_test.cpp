...
public:
    ...
    std::string CreateTempFile(const std::string &dir, const std::string &name)
    {
...
/**
 * @tc.number: Install_NullStatusReceiver_001
 * @tc.name: test LocalPluginInstallerProxy::Install
*/
HWTEST_F(LocalPluginInstallerProxyTest, Install_NullStatusReceiver_001, TestSize.Level1)
{
...
/**
 * @tc.number: Install_EmptyPluginFilePaths_002
 * @tc.name: test LocalPluginInstallerProxy::Install
*/
HWTEST_F(LocalPluginInstallerProxyTest, Install_EmptyPluginFilePaths_002, TestSize.Level1)
{
...
/**
 * @tc.number: Install_InvalidFileSuffix_003
 * @tc.name: test LocalPluginInstallerProxy::Install
*/
HWTEST_F(LocalPluginInstallerProxyTest, Install_InvalidFileSuffix_003, TestSize.Level1)
{
    sptr<MockStatusReceiver> receiver = new MockStatusReceiver();
...
/**
 * @tc.number: Install_FilePathStatFailed_004
 * @tc.name: test LocalPluginInstallerProxy::Install
*/
HWTEST_F(LocalPluginInstallerProxyTest, Install_FilePathStatFailed_004, TestSize.Level1)
{
    sptr<MockStatusReceiver> receiver = new MockStatusReceiver();
...
/**
 * @tc.number: DestroyStreamInstaller_Normal_012
 * @tc.name: test LocalPluginInstallerProxy::DestroyLocalPluginStreamInstaller
*/
HWTEST_F(LocalPluginInstallerProxyTest, DestroyStreamInstaller_Normal_012, TestSize.Level1)
{
...
/**
 * @tc.number: DestroyStreamInstaller_SendRequestFailed_013
 * @tc.name: test LocalPluginInstallerProxy::DestroyLocalPluginStreamInstaller
*/
HWTEST_F(LocalPluginInstallerProxyTest, DestroyStreamInstaller_SendRequestFailed_013, TestSize.Level1)
{
...
/**
 * @tc.number: DestroyStreamInstaller_ReplyFalse_014
 * @tc.name: test LocalPluginInstallerProxy::DestroyLocalPluginStreamInstaller
*/
HWTEST_F(LocalPluginInstallerProxyTest, DestroyStreamInstaller_ReplyFalse_014, TestSize.Level1)
{
...
/**
 * @tc.number: Uninstall_NullStatusReceiver_015
 * @tc.name: test LocalPluginInstallerProxy::Uninstall
*/
HWTEST_F(LocalPluginInstallerProxyTest, Uninstall_NullStatusReceiver_015, TestSize.Level1)
{
    sptr<IStatusReceiver> nullReceiver = nullptr;
...
/**
 * @tc.number: Uninstall_SendRequestFailed_016
 * @tc.name: test LocalPluginInstallerProxy::Uninstall
*/
HWTEST_F(LocalPluginInstallerProxyTest, Uninstall_SendRequestFailed_016, TestSize.Level1)
{
    sptr<MockStatusReceiver> receiver = new MockStatusReceiver();
    mockRemote_->shouldFail_ = true;
...
/**
 * @tc.number: Uninstall_ThreeParam_SendRequestFailed_019
 * @tc.name: test LocalPluginInstallerProxy::Uninstall
*/
HWTEST_F(LocalPluginInstallerProxyTest, Uninstall_ThreeParam_SendRequestFailed_019, TestSize.Level1)
{
    mockRemote_->shouldFail_ = true;
...
/**
 * @tc.number: Uninstall_ThreeParam_Success_020
 * @tc.name: test LocalPluginInstallerProxy::Uninstall
*/
HWTEST_F(LocalPluginInstallerProxyTest, Uninstall_ThreeParam_Success_020, TestSize.Level1)
{
    ErrCode ret = proxy_->Uninstall(TEST_BUNDLE_NAME, TEST_PLUGIN_BUNDLE_NAME, TEST_USER_ID);
...
/**
 * @tc.number: Uninstall_ThreeParam_HostError_021
 * @tc.name: test LocalPluginInstallerProxy::Uninstall
*/
HWTEST_F(LocalPluginInstallerProxyTest, Uninstall_ThreeParam_HostError_021, TestSize.Level1)
{
...
/**
 * @tc.number: WriteFileToStream_NullStreamInstaller_022
 * @tc.name: test LocalPluginInstallerProxy::WriteFileToLocalPluginStream
*/
HWTEST_F(LocalPluginInstallerProxyTest, WriteFileToStream_NullStreamInstaller_022, TestSize.Level1)
{
...
/**
 * @tc.number: CreatePluginFileStream_EmptyFileName_001
 * @tc.name: test LocalPluginStreamInstallerProxy::CreatePluginFileStream
*/
HWTEST_F(LocalPluginStreamInstallerProxyTest, CreatePluginFileStream_EmptyFileName_001, TestSize.Level1)
{
...
/**
 * @tc.number: CreatePluginFileStream_SendRequestFailed_002
 * @tc.name: test LocalPluginStreamInstallerProxy::CreatePluginFileStream
*/
HWTEST_F(LocalPluginStreamInstallerProxyTest, CreatePluginFileStream_SendRequestFailed_002, TestSize.Level1)
{
    mockRemote_->shouldFail_ = true;
...
/**
 * @tc.number: CreatePluginFileStream_ReadFileDescriptorFailed_003
 * @tc.name: test LocalPluginStreamInstallerProxy::CreatePluginFileStream
*/
HWTEST_F(LocalPluginStreamInstallerProxyTest, CreatePluginFileStream_ReadFileDescriptorFailed_003, TestSize.Level1)
{
...
/**
 * @tc.number: CreatePluginFileStream_ParcelWriteFailed_005
 * @tc.name: test LocalPluginStreamInstallerProxy::CreatePluginFileStream
*/
HWTEST_F(LocalPluginStreamInstallerProxyTest, CreatePluginFileStream_ParcelWriteFailed_005, TestSize.Level1)
{
    mockRemote_->shouldFail_ = true;
...
/**
 * @tc.number: CommitLocalPluginInstall_SendRequestFailed_006
 * @tc.name: test LocalPluginStreamInstallerProxy::CommitLocalPluginInstall
*/
HWTEST_F(LocalPluginStreamInstallerProxyTest, CommitLocalPluginInstall_SendRequestFailed_006, TestSize.Level1)
{
    mockRemote_->shouldFail_ = true;
...
/**
 * @tc.number: CommitLocalPluginInstall_Success_007
 * @tc.name: test LocalPluginStreamInstallerProxy::CommitLocalPluginInstall
*/
HWTEST_F(LocalPluginStreamInstallerProxyTest, CommitLocalPluginInstall_Success_007, TestSize.Level1)
{
    bool ret = proxy_->CommitLocalPluginInstall();
    EXPECT_TRUE(ret);
    EXPECT_TRUE(mockRemote_->sendRequestCalled_);
...
/**
 * @tc.number: GetSetInstallerId_009
 * @tc.name: test LocalPluginStreamInstallerProxy::GetLocalPluginInstallerId
*/
HWTEST_F(LocalPluginStreamInstallerProxyTest, GetSetInstallerId_009, TestSize.Level1)
{
