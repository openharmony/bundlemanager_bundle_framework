...
// 1000 0000 0000 0000 represents usb connection service
constexpr uint32_t VALUE_USB_CONNECTION = 1 << 15;
...
constexpr const char* KEY_USB_CONNECTION = "usbConnection";
}  // namespace ProfileReader
...
constexpr const char* SKILL_PROFILE_VISIBILITY_PUBLIC = "public";
constexpr const char* SKILL_PROFILE_VISIBILITY_SYSTEM = "system";
