...
{
    std::string bundleName = Str16ToStr8(data.ReadString16());
    std::string hapRealPath = Str16ToStr8(data.ReadString16());
    std::string tempDirName = Str16ToStr8(data.ReadString16());
...
bool InstalldHost::HandleExtractArkNative(MessageParcel &data, MessageParcel &reply)
{
    std::string bundleName = Str16ToStr8(data.ReadString16());
    std::string moduleName = Str16ToStr8(data.ReadString16());
    std::string hapFilePath = Str16ToStr8(data.ReadString16());
...
bool InstalldHost::HandleExtractResFileDir(MessageParcel &data, MessageParcel &reply)
{
    std::string bundleName = Str16ToStr8(data.ReadString16());
    std::string moduleName = Str16ToStr8(data.ReadString16());
    std::string hapFilePath = Str16ToStr8(data.ReadString16());
