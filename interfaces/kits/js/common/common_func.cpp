...
static std::unordered_map<int32_t, int32_t> ERR_MAP = {
    ...
    { ERR_BUNDLE_MANAGER_DEFAULT_APP_PERMISSION_DENIED, ERROR_DEFAULT_APP_PERMISSION_DENIED },
    ...
    { ERR_SHORTCUT_MANAGER_SHORTCUT_NOT_EXIST, ERROR_SHORTCUT_MANAGER_NOT_EXIST },
    { ERR_APPEXECFWK_DUAL_MODE_DEVICE_NOT_SUPPORTED, ERROR_DUAL_MODE_DEVICE_NOT_SUPPORTED },
    { ERR_APPEXECFWK_DUAL_MODE_POLICY_INVALID, ERROR_DUAL_MODE_POLICY_INVALID },
    { ERR_APPEXECFWK_DUAL_MODE_SWITCH_BUSY, ERROR_DUAL_MODE_SWITCH_BUSY },
    { ERR_APPEXECFWK_DUAL_MODE_PERSIST_FAILED, ERROR_DUAL_MODE_SWITCH_BUSY },
};
}
