...
void CreateExtensionAbilityTypeObject(napi_env env, napi_value value)
{
    ...
    napi_value nSysDialogPrint;
    NAPI_CALL_RETURN_VOID(env, napi_create_int32(env,
        static_cast<int32_t>(ExtensionAbilityType::SYSDIALOG_PRINT), &nSysDialogPrint));
    NAPI_CALL_RETURN_VOID(env, napi_set_named_property(env, value, "SYSDIALOG_PRINT",
        nSysDialogPrint));
