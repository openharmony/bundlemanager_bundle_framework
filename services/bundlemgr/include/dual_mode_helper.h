...
public:
    ...
    // Returns true if system mode parameter is configured and valid (pcmode/padmode).
...
private:
    ...
    // Initialize cache by reading system parameters (called internally on first use)
