...
#include "bmsgetbundlepackinfo_fuzzer.h"
...
bool DoSomethingInterestingWithMyAPI(const uint8_t* data, size_t size)
{
    ...
    BundlePackFlag flag = static_cast<BundlePackFlag>(flags);
    BundlePackInfo bundlePackInfo;
    int32_t userId = BMSFuzzTestUtil::GenerateRandomUser(fdp);
    bundleMgrProxy.GetBundlePackInfo(bundleName, flag, bundlePackInfo, userId);
