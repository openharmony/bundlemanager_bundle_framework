...
bool ApplicationInfo::Marshalling(Parcel &parcel) const
{
    ...
    WRITE_PARCEL_AND_RETURN_FALSE_IF_FAIL(Uint32, parcel, appCategory);
    return true;
}
...
void from_json(const nlohmann::json &jsonObject, ApplicationInfo &applicationInfo)
{
    ...
    GetValueIfFindKey<int32_t>(jsonObject, jsonObjectEnd, APPLICATION_APP_CATEGORY,
